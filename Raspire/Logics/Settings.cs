...
namespace Raspire
{
    public class Settings
    {
        ...
        public void DefaultSettings()//default data template
        {
            ...
            Subjects = new ObservableCollection<Subject>();
            foreach (string subject in "Математика;Русский язык;Литература;История;Обществозание;География;Биология;Информатика;Английский язык;Физика;Химия;ИЗО;Музыка;МХК;Чтение;Окружающий мир;ОБЖ;Пустой".Split(";"))
            {
